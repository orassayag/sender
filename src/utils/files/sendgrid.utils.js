import { SendGridCodeModel } from '../../core/models/application/index.js';
import { SendGridReasonEnum } from '../../core/enums/index.js';
...
class SendGridUtils {
  constructor() {
    this.resultCodesList = {
      ...
      405: new SendGridCodeModel({
        ...
        description:
          'There was a method not allowed problem with your request.',
        isSent: false,
      }),
      ...
      415: new SendGridCodeModel({
        ...
        description:
          'There was a method not unsupported media type problem with your request.',
        isSent: false,
      }),
  ...
  initiate() {
    ...
    for (let i = 0; i < keys.length; i++) {
      ...
      if (
        !this.limitExceededCode &&
        this.resultCodesList[code].reason ===
          SendGridReasonEnum.TOO_MANY_REQUESTS
      ) {
